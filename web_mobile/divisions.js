globalThis.TAIWAN_DISTRICTS = Object.freeze({
  "台北市": ["中山區", "中正區", "信義區", "內湖區", "北投區", "南港區", "士林區", "大同區", "大安區", "文山區", "松山區", "萬華區"],
  ...
  "台中市": ["中區", "北區", "北屯區", "南區", "南屯區", "后里區", "和平區", "外埔區", "大安區", "大甲區", "大肚區", "大里區", "大雅區", "太平區", "新社區", "東勢區", "東區", "梧棲區", "沙鹿區", "清水區", "潭子區", "烏日區", "石岡區", "神岡區", "西區", "西屯區", "豐原區", "霧峰區", "龍井區"],
  "台南市": ["七股區", "下營區", "中西區", "仁德區", "佳里區", "六甲區", "北區", "北門區", "南化區", "南區", "善化區", "大內區", "學甲區", "安南區", "安定區", "安平區", "官田區", "將軍區", "山上區", "左鎮區", "後壁區", "新化區", "新市區", "新營區", "東區", "東山區", "柳營區", "楠西區", "歸仁區", "永康區", "玉井區", "白河區", "西港區", "關廟區", "鹽水區", "麻豆區", "龍崎區"],
  ...
  "屏東縣": ["三地門鄉", "九如鄉", "佳冬鄉", "來義鄉", "內埔鄉", "南州鄉", "屏東市", "崁頂鄉", "恆春鎮", "新園鄉", "新埤鄉", "春日鄉", "東港鎮", "枋寮鄉", "枋山鄉", "林邊鄉", "泰武鄉", "滿州鄉", "潮州鎮", "牡丹鄉", "獅子鄉", "琉球鄉", "瑪家鄉", "竹田鄉", "萬丹鄉", "萬巒鄉", "車城鄉", "里港鄉", "長治鄉", "霧台鄉", "高樹鄉", "鹽埔鄉", "麟洛鄉"],
  "宜蘭縣": ["三星鄉", "五結鄉", "冬山鄉", "南澳鄉", "員山鄉", "壯圍鄉", "大同鄉", "宜蘭市", "礁溪鄉", "羅東鎮", "蘇澳鎮", "頭城鎮"],
  "花蓮縣": ["光復鄉", "卓溪鄉", "吉安鄉", "壽豐鄉", "富里鄉", "新城鄉", "玉里鎮", "瑞穗鄉", "秀林鄉", "花蓮市", "萬榮鄉", "豐濱鄉", "鳳林鎮"],
  "台東縣": ["卑南鄉", "台東市", "大武鄉", "太麻里鄉", "延平鄉", "成功鎮", "東河鄉", "池上鄉", "海端鄉", "綠島鄉", "蘭嶼鄉", "達仁鄉", "金峰鄉", "長濱鄉", "關山鎮", "鹿野鄉"],
